#  HSSBLoggerで利用されるログファイルフォーマット仕様書


> [!NOTE]
> HSSBLoggerはHSSoundBasisLibに搭載されるロギングライブラリです。<br>

## 目次

1. [目次](#目次)
2. [概要](#概要)
3. [フォーマット名について](#フォーマット名について)
4. [コンセプト](#コンセプト)
...
8. [ロガー実装者へ向けた補足資料](#ロガー実装者へ向けた補足資料)
...
> [!NOTE]
> このセクションのSHA-256ハッシュ値の計算方法は特殊です。<br>
> 詳細は後述の説明を参照してください。
